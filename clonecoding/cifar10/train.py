...
def train_one_epoch(dataloader: DataLoader, device, model: nn.Module, loss_fn: nn.Module, optimizer) -> None:
    """
    CIFAR-10 is train newral network in dataset

    :param dataloader: pytorch dataloader
    :type dataloader: DataLoader
    :pram device: device used at train
    :type model: nn.Module
    :param loss_fn: loss function used at train
    :param optimizer: optimzizer used at train
    :type optimizer: torch.optim.Optimzizer
    """
